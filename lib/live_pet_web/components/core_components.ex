defmodule LivePetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivePetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivePetWeb.Gettext, "errors", msg, opts)
    end
  end
